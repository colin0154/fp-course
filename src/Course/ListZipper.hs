...
instance Functor ListZipper where
  f <$> ListZipper l n r = ListZipper l' n' r'
                            where l' = map f l
                                  n' = f n
                                  r' = map f r 
...
toList (ListZipper l n r) = reverse l ++ (n :. Nil) ++ r
...
withFocus f (ListZipper l n r) = ListZipper l (f n) r
...
findLeft p (ListZipper l n r) = case break p l of
                                (_, Nil) -> isNotZ
                                (r', n':.l') -> isZ (ListZipper l' n' (reverse r' ++ n :. r))
...
findRight p (ListZipper l n r) = case break p r of
                                  (_, Nil) -> isNotZ
                                  (l', n':.r') -> isZ (ListZipper (reverse l' ++ n:.l) n' r')
...
moveLeftLoop (ListZipper Nil n r) = let (h :. r') = reverse (n :. r)
                                    in ListZipper r' h Nil
moveLeftLoop (ListZipper (h:.l) n r) = ListZipper l h (n:.r)
...
moveRightLoop (ListZipper l n Nil) = let (h :. l') = reverse (n :. l)
                                      in ListZipper Nil h l'
moveRightLoop (ListZipper l n (h:.r)) = ListZipper (n:.l) h r
...
moveLeft (ListZipper (h:.l) n r) = isZ (ListZipper l h (n:.r))
...
moveRight (ListZipper l n (h:.r)) = isZ (ListZipper (n:.l) h r)
...
swapLeft (ListZipper (h:.l) n r) = isZ (ListZipper (n:.l) h r)
...
swapRight (ListZipper l n (h:.r)) = isZ (ListZipper l h (n:.r))
...
dropLefts (ListZipper _ n r) = ListZipper Nil n r
...
dropRights (ListZipper l n _) = ListZipper l n Nil
